...
namespace Aplicacao.UseCases.Produtos.Criar
{
    ...
    {
        public CriarCommand(string nome, decimal preco, Domain.Entidades.Categoria categoria, List<Imagem>? imagens, string descricao, List<Domain.Entidades.Ingrediente>? ingredientes = null)
        {
            Nome = nome;
            Preco = preco;
            Descricao = descricao;
