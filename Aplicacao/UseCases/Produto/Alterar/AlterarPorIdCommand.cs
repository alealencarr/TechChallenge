...
namespace Aplicacao.UseCases.Produtos.Alterar
{
    ...
    {
        public AlterarPorIdCommand(string nome, decimal preco, Domain.Entidades.Categoria categoria, List<Imagem>? imagens, string descricao, string id, List<Domain.Entidades.Ingrediente>? ingredientes = null)
        {
            Nome = nome;
            Preco = preco;
            Descricao = descricao;
