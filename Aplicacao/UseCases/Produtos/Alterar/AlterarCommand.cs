...
namespace Aplicacao.UseCases.Produtos.Alterar
{
    ...
    {
        public AlterarCommand(string nome, decimal preco, Domain.Entidades.Categoria categoria, List<Imagem>? imagens, string descricao, List<Ingrediente>? ingredientes = null)
        {
            Nome = nome;
            Preco = preco;
            Descricao = descricao;
